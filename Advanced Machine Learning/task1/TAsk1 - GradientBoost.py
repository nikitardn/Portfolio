...
def fitdata(x, y,):
    ...
    reg=GradientBoostingRegressor(n_estimators=NB_ESTIMATORS, verbose=True, learning_rate=LEARNING_RATE, loss='ls', max_depth=4)
...
if __name__ == '__main__':
    ...
    reg, x_test, y_test = fitdata(x_selected, y_inliers,)
